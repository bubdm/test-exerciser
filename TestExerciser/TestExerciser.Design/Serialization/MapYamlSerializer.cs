...
namespace DesignTE.Serialization
{
    public partial class MapYamlSerializer
    {
        ...
        /// <param name="r"></param>
        /// <returns></returns>
        public MapNode Deserialize(IParser r)
        {
        ...
        private MapNode DeserializeIsolatedNode(IParser r)
        {
        ...
        private void DeserializeScalarProperties(MapNode node, IParser r)
        {
            ...
            if (prop != null && prop.Value.Equals(TextAlignment))
            {
                r.Expect<Scalar>();
