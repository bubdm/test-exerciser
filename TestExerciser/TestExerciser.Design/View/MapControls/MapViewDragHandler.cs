...
namespace DesignTE.View.MapControls
{
    public class MapViewDragHandler
    {
        ...
        {
            MapView = mapView;
            nodeDragCursor = new Cursor(new System.IO.MemoryStream(DesignTE.Properties.Resources.DragMove));
            canvasDragCursor = new Cursor(new System.IO.MemoryStream(DesignTE.Properties.Resources.HandDrag));
