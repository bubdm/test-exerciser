...
//using DesignTE.Plugins.Tasks.Properties;

namespace DesignTE.Plugins.Tasks.SideBar
{
    [ToolboxBitmap(typeof(CollapsiblePanel), "DesignTE.Plugins.Tasks.CollapsiblePanel.bmp")]
