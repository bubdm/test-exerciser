namespace DesignTE.Plugins.Tasks
{
    partial class TaskView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTaskPath = new DesignTE.Plugins.Tasks.TransparentLabel();
            this.lblDueOn = new DesignTE.Plugins.Tasks.TransparentLabel();
            this.lblNodeName = new DesignTE.Plugins.Tasks.TransparentLabel();
            this.SuspendLayout();
            // 
            // btnRemove
            // 
