...
namespace DesignTE.Plugins.Tasks.Reminder
{
    public class ReminderCtrl
    {
        ...
        private void Reminder_TaskDue(DesignTE.Model.MapNode node, ReminderType reminderType)
        {
        ...
        private void PendingTasks_TaskChanged(DesignTE.Model.MapNode node, Model.PendingTaskEventArgs args)
        {
