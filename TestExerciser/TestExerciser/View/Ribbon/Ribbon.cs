...
namespace DesignTE.View.Ribbon
{
    public partial class Ribbon
    {
        ...
        public Ribbon(RibbonLib.Ribbon ribbon, Controller.MainCtrl mainCtrl, IMainForm mainForm)
        {
            ...
            ApplicationMenu.TooltipTitle = "菜单";
            ApplicationMenu.TooltipDescription = "应用程序主菜单";
            ...
            DesignTE.Model.ClipboardManager.StatusChanged += ClipboardManager_StatusChanged;
        ...
        {
            NodeShape.LargeImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Node_Format_Bubble);
            Bullets.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.Bullets_SmallImage);
            Numbers.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.Numbers_SmallImage);
            Outdent.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.Outdent_SmallImage);
            Indent.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.Indent_SmallImage);
            AlignLeft.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.AlignLeft_SmallImage);
            AlignCenter.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.AlignCenter_SmallImage);
            AlignRight.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.AlignRight_SmallImage);
            Justify.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.Justify_SmallImage);
            NoteHeading1.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading1_32bit);
            NoteHeading1.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading1_16bit);
            NoteHeading2.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading2_32bit);
            NoteHeading2.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading2_16bit);
            NoteHeading3.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading3_32bit);
            NoteHeading3.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteHeading3_16bit);
            NoteNormal.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteNormal_32bit);
            NoteNormal.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteNormal_16bit);
            NoteInsertTable.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertTable_SmallImage);
            NoteInsertTable.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertTable_LargeImage);
            NoteEditHtml.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteEditHtml_16bit);
            NoteEditHtml.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.NoteEditHtml_32bit);
            ModifyTableProperties.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.TableProperties_SmallImage);
            ModifyTableProperties.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.TableProperties_LargeImage);
            DeleteRow.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteRow_SmallImage);
            DeleteRow.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteTable_LargeImage);
            DeleteColumn.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteColumn_SmallImage);
            DeleteColumn.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteColumn_LargeImage);
            DeleteTable.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteTable_SmallImage);
            DeleteTable.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.DeleteTable_LargeImage);
            InsertRowAbove.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertRowAbove_SmallImage);
            InsertRowAbove.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertRowAbove_LargeImage);
            InsertRowBelow.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertRowBelow_SmallImage);
            InsertRowBelow.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertRowBelow_LargeImage);
            InsertColumnLeft.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertColumnLeft_SmallImage);
            InsertColumnLeft.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertColumnLeft_LargeImage);
            InsertColumnRight.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertColumnRight_SmallImage);
            InsertColumnRight.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.InsertColumnRight_LargeImage);
            MoveRowUp.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveRowUp_SmallImage);
            MoveRowUp.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveRowUp_LargeImage);
            MoveRowDown.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveRowDown_SmallImage);
            MoveRowDown.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveRowDown_LargeImage);
            MoveColumnLeft.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveColumnLeft_SmallImage);
            MoveColumnLeft.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveColumnLeft_LargeImage);
            MoveColumnRight.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveColumnRight_SmallImage);
            MoveColumnRight.LargeImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.MoveColumnRight_LargeImage);
        ...
        private void _iconGallery_ItemsSourceReady(object sender, EventArgs e)
        {
            ...
            RemoveLastIcon.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.minus);
            RemoveAllIcons.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.cross_script);
            LaunchIconsDialog.SmallImage = ribbon.ConvertToUIImage(DesignTE.Properties.Resources.smartart_change_color_gallery_16);
        }
        ...
        private void SortOrder_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            if (SortOrder.Label == null || SortOrder.Label.Equals(AscendingOrderString)) //ascending, swtich to descending
            {
                ...
                SortOrder.SmallImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Descending_Sorting_32);
            }
            else //switch to ascending
            {
                ...
                SortOrder.SmallImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Ascending_Sorting_32);
            }
        ...
        private void NodeShape_ItemsSourceReady(object sender, EventArgs e)
        {
            ...
            {
                Label = "Fork",
                ItemImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Node_Format_Fork)
            });
            itemSource.Add(new GalleryItemPropertySet()
            {
                Label = "Bubble",
                ItemImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Node_Format_Bubble)
            });
            itemSource.Add(new GalleryItemPropertySet()
            {
                Label = "Box",
                ItemImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Node_Format_Box)
            });
            itemSource.Add(new GalleryItemPropertySet()
            {
                Label = "Bullet",
                ItemImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.Node_Format_Bullet)
            });
        }
        ...
        private void ClipboardManager_StatusChanged()
        {
            ...
            {
                Cut.SmallImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.cut_red_small);
            }
            else
            {
                Cut.SmallImage = ribbon.ConvertToUIImage(TestExerciser.Properties.Resources.cut_small);
            }
        }
