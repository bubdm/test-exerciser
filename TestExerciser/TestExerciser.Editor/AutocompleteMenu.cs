...
namespace EditorTE
{
    ...
    public class AutocompleteListView : UserControl
    {
        ...
        internal AutocompleteListView(Editor tb)
        {
            ...
            tb.SelectionChanged += new EventHandler(tSelectionChanged);
            tb.KeyPressed += new KeyPressEventHandler(tKeyPressed);
        ...
        void tKeyPressed(object sender, KeyPressEventArgs e)
        {
        ...
        void tSelectionChanged(object sender, EventArgs e)
        {
            /*
